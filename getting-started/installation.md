...
Java 1.7.x is the minimum, but has reached end of life.  We recommend 1.8.x.
...
over at the Java 8 install page</a>. Make sure you're using OpenJDK or Oracle's JDK.
