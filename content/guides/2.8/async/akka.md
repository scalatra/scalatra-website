...
```scala
"com.typesafe.akka" %% "akka-actor" % "{{< 2-8-akka_version >}}",
...
<div class="alert alert-info">
  ...
  See
  <a href="https://github.com/scalatra/scalatra-website-examples/tree/master/{{< 2-8-scalatra_short_version >}}/async/akka-examples">akka-examples</a>
