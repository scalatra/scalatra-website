...
<div class="alert alert-info">
  ...
  See
  <a href="https://github.com/scalatra/scalatra-website-examples/tree/master/{{<2-8-scalatra_short_version>}}/http/scalatra-gzip">scalatra-gzip</a>
...
class GZipApp extends ScalatraServlet with ContentEncodingSupport {
  ...
  get("/") {
    <html>
      <body>
        <h1>This is
          <a href="http://scalatra.org/guides/{{<2-8-scalatra_short_version>}}/http/gzip.html">
            http/gzip
          </a>!
        </h1>
      </body>
