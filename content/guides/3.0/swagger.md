...
<div class="alert alert-info">
  ...
  See
  <a href="https://github.com/scalatra/scalatra-website-examples/tree/master/{{<3-0-scalatra_short_version>}}/swagger-example">swagger-example</a>
...
```scala
  "org.scalatra" %% "scalatra-json" % "{{< 2-8-scalatra_version >}}",
  "org.json4s"   %% "json4s-native" % "{{< 2-8-json4s_version >}}",
```
...
First, add the Swagger dependency to your `build.sbt` file, then restart your
app to grab the new jars:

```scala
// for javax
"org.scalatra" %% "scalatra-swagger-javax"  % "{{< 3-0-scalatra_version >}}",

// for jakarta
"org.scalatra" %% "scalatra-swagger-jakarta"  % "{{< 3-0-scalatra_version >}}",
```
...
<div class="alert alert-info">
  <span class="badge badge-info"><i class="glyphicon glyphicon-flag"></i></span>
  Note that the <code>context.mount(new FlowersController, "/flowers", "flowers")</code> has a second
...
<div class="alert alert-info">
  <span class="badge badge-info"><i class="glyphicon glyphicon-flag"></i></span>
  It's very important to get the api-docs path correct when you browse your docs in swagger-ui. Be careful: there's no trailing slash on <code>http://localhost:8080/api-docs</code>,
