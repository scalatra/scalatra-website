...
|Scalatra version |Scala versions        |Servlet versions |
|-----------------|----------------------|-----------------|
|3.2.x            |2.13.x, 3.3.x.        |4.0.1, 6.1.0     |
|3.1.x            |2.12.x, 2.13.x, 3.3.x |4.0.1, 6.0.0     |
|3.0.x            |2.12.x, 2.13.x, 3.3.x |4.0.1, 5.0.0     |

Note that the artifact names have suffix depending on Servlet version as follows:

```scala
// for javax (Servlet 4.0.1)
"org.scalatra" %% "scalatra-javax" % "{{< 3-scalatra_version >}}",
"org.scalatra" %% "scalatra-json-javax" % "{{< 3-scalatra_version >}}",
"org.scalatra" %% "scalatra-forms-javax" % "{{< 3-scalatra_version >}}",
...

// for jakarta (Servlet 5.0.0/6.0.0/6.1.0)
"org.scalatra" %% "scalatra-jakarta" % "{{< 3-scalatra_version >}}",
"org.scalatra" %% "scalatra-json-jakarta" % "{{< 3-scalatra_version >}}",
"org.scalatra" %% "scalatra-forms-jakarta" % "{{< 3-scalatra_version >}}",
...
```
