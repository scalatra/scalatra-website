...
```scala
"org.apache.pekko" %% "pekko-actor" % "{{< 3-pekko_version >}}",
...
<div class="alert alert-info">
  ...
  See
  <a href="https://github.com/scalatra/scalatra-website-examples/tree/master/{{< 3-scalatra_short_version >}}/async/pekko-examples">pekko-examples</a>
