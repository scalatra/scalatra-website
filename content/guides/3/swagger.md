...
<div class="alert alert-info">
  ...
  See
  <a href="https://github.com/scalatra/scalatra-website-examples/tree/master/{{<3-scalatra_short_version>}}/swagger-example">swagger-example</a>
...
```scala
// for javax
"org.scalatra" %% "scalatra-swagger-javax"  % "{{< 3-scalatra_version >}}",

// for jakarta
"org.scalatra" %% "scalatra-swagger-jakarta"  % "{{< 3-scalatra_version >}}",
```
